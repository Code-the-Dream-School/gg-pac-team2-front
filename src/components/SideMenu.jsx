  ...
  return (
    <>
      ...
      <div ref={openNavRef} className="sidenav shadow">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="40" viewBox="0 0 24 24" fill="none"
               stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
               className="feather feather-download">
            <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" stroke="#5f6368"></path>
            <polyline points="7 10 12 15 17 10" stroke="#5f6368"></polyline>
            <line x1="12" y1="15" x2="12" y2="3" stroke="#5f6368"></line>
          </svg>
          &nbsp;Received Requests
        </div>
        <div
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none"
            ...
            <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" stroke="#5f6368"></path>
            <polyline points="17 14 12 9 7 14" stroke="#5f6368"></polyline>
            <line x1="12" y1="9" x2="12" y2="21" stroke="#5f6368"></line>
          </svg>
          &nbsp;Sent Requests
        </div>
        <div>
