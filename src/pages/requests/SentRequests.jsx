...
import {getProfiles, getReceivedRequests, getSentRequests, sendRideRequest} from "../../services/api.js";
import ReceivedRequestList from "../../components/ReceivedRequestList/ReceivedRequestList.jsx";
import Button from "../../components/Button.jsx";
import SentRequestList from "../../components/SentRequestList/SentRequestList.jsx";
  ...
  useEffect(() => {
    ...
    if (credentials.token) {
      const fetchProfiles = async () => {
        try {
          const receivedRequestList = await getSentRequests(credentials.token);
    ...
    <>
      <div className="container-fluid">
        ...
        <Container className={"mb-4"}>
          <h1 className={"mt-4 text-center"}>Sent Ride Requests</h1>
          {alertMsg.msg && (
          ...
          <SentRequestList receivedRequests={filteredProfiles} rideRequestHandler={rideRequestHandler}/>
        </Container>
